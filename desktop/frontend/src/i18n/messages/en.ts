export const en = {
  ...
  settings: {
    ...
    relay: {
      ...
      insecureMode: "insecure mode",
      insecureWarning: "Connects to the relay over http:// without TLS. An attacker on the network path between this client and the relay could read or tamper with traffic. Use only on a trusted private network.",
