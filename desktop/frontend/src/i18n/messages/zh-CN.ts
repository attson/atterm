...
export const zhCN = {
  ...
  settings: {
    ...
    relay: {
      ...
      insecureMode: "insecure 模式",
      insecureWarning: "通过 http:// 明文连接 relay，不启用传输层 TLS 加密。位于客户端与 relay 之间链路上的攻击者可窃听或篡改流量。仅在可信私有网络中使用。",
    ...
    webhooks: {
      title: "Webhook",
      hint: "Relay 会话进入关键状态时向外推送通知。配置绑定在你的 Relay 账号上，多端共享。",
      empty: "还没有 Webhook，在下方添加一个。",
      listTitle: "已配置的 Webhook",
      addTitle: "添加 Webhook",
      createdAt: "添加于 {date}",
      fields: {
        name: "名称",
        namePlaceholder: "如 team-alerts",
        url: "URL",
        urlPlaceholder: "https://hook.example.com/...",
        format: "格式",
        allowInsecure: "允许 http://（不安全）",
      },
      formats: {
        generic: "通用 JSON",
        feishu: "飞书机器人",
      ...
      actions: {
        ...
        creating: "添加中…",
        delete: "删除",
        confirmDeleteTitle: "删除该 Webhook？",
        confirmDeleteBody: "通知将不再发送到这个地址。",
        cancel: "取消",
      },
      errors: {
        generic: "保存失败，请稍后重试。",
        network: "无法连接 Relay，请检查网络后重试。",
        unauthorized: "Relay 登录已失效，请到 Relay 标签页重新登录。",
        invalid_url: "URL 必须是 http(s) 且包含 host。",
        invalid_format: "请选择支持的格式。",
        insecure_url: "明文 http 需勾选「允许 http://」。",
        name_required: "请给 Webhook 起个名字。",
        too_many: "已达到账号 Webhook 数量上限。",
        not_configured: "请先在 Relay 标签页配置 Relay。",
        not_found: "该 Webhook 已不存在。",
      },
    },
    updates: {
