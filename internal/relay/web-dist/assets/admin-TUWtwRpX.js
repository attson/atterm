...
`,[F("scrollbar",`
 ...
 transition: color .3s var(--n-bezier);
 `,[vn({enterScale:"0.5"})])])]),ur=se({name:"InternalSelectMenu",props:Object.assign(Object.assign({},Pe.props),{clsPrefix:{type:String,required:!0},scrollable:{type:Boolean,default:!0},treeMate:{type:Object,required:!0},multiple:Boolean,size:{type:String,default:"medium"},value:{type:[String,Number,Array],default:null},autoPending:Boolean,virtualScroll:{type:Boolean,default:!0},show:{type:Boolean,default:!0},labelField:{type:String,default:"label"},valueField:{type:String,default:"value"},loading:Boolean,focusable:Boolean,renderLabel:Function,renderOption:Function,nodeProps:Function,showCheckmark:{type:Boolean,default:!0},onMousedown:Function,onScroll:Function,onFocus:Function,onBlur:Function,onKeyup:Function,onKeydown:Function,onTabOut:Function,onMouseenter:Function,onMouseleave:Function,onResize:Function,resetMenuOnOptionsChange:{type:Boolean,default:!0},inlineThemeDisabled:Boolean,onToggle:Function}),setup(e){const{mergedClsPrefixRef:t,mergedRtlRef:n}=Ee(e),o=mt("InternalSelectMenu",n,t),r=Pe("InternalSelectMenu","-internal-select-menu",_a,Zr,e,ae(e,"clsPrefix")),a=$(null),s=$(null),l=$(null),d=P(()=>e.treeMate.getFlattenedNodes()),u=P(()=>ha(d.value)),c=$(null);function p(){const{treeMate:w}=e;let O=null;const{value:D}=e;D===null?O=w.getFirstAvailableNode():(e.multiple?O=w.getNode((D||[])[(D||[]).length-1]):O=w.getNode(D),(!O||O.disabled)&&(O=w.getFirstAvailableNode())),I(O||null)}function g(){const{value:w}=c;w&&!e.treeMate.getNode(w.key)&&(c.value=null)}let b;Ye(()=>e.show,w=>{w?b=Ye(()=>e.treeMate,()=>{e.resetMenuOnOptionsChange?(e.autoPending?p():g(),_t(N)):g()},{immediate:!0}):b==null||b()},{immediate:!0}),un(()=>{b==null||b()});const v=P(()=>At(r.value.self[me("optionHeight",e.size)])),f=P(()=>Wt(r.value.self[me("padding",e.size)])),h=P(()=>e.multiple&&Array.isArray(e.value)?new Set(e.value):new Set),m=P(()=>{const w=d.value;return w&&w.length===0});function x(w){const{onToggle:O}=e;O&&O(w)}function S(w){const{onScroll:O}=e;O&&O(w)}function C(w){var O;(O=l.value)===null||O===void 0||O.sync(),S(w)}function R(){var w;(w=l.value)===null||w===void 0||w.sync()}function z(){const{value:w}=c;return w||null}function E(w,O){O.disabled||I(O,!1)}function G(w,O){O.disabled||x(O)}function T(w){var O;ot(w,"action")||(O=e.onKeyup)===null||O===void 0||O.call(e,w)}function M(w){var O;ot(w,"action")||(O=e.onKeydown)===null||O===void 0||O.call(e,w)}function X(w){var O;(O=e.onMousedown)===null||O===void 0||O.call(e,w),!e.focusable&&w.preventDefault()}function _(){const{value:w}=c;w&&I(w.getNext({loop:!0}),!0)}function k(){const{value:w}=c;w&&I(w.getPrev({loop:!0}),!0)}function I(w,O=!1){c.value=w,O&&N()}function N(){var w,O;const D=c.value;if(!D)return;const J=u.value(D.key);J!==null&&(e.virtualScroll?(w=s.value)===null||w===void 0||w.scrollTo({index:J}):(O=l.value)===null||O===void 0||O.scrollTo({index:J,elSize:v.value}))}function j(w){var O,D;!((O=a.value)===null||O===void 0)&&O.contains(w.target)&&((D=e.onFocus)===null||D===void 0||D.call(e,w))}function U(w){var O,D;!((O=a.value)===null||O===void 0)&&O.contains(w.relatedTarget)||(D=e.onBlur)===null||D===void 0||D.call(e,w)}Ze(qn,{handleOptionMouseEnter:E,handleOptionClick:G,valueSetRef:h,pendingTmNodeRef:c,nodePropsRef:ae(e,"nodeProps"),showCheckmarkRef:ae(e,"showCheckmark"),multipleRef:ae(e,"multiple"),valueRef:ae(e,"value"),renderLabelRef:ae(e,"renderLabel"),renderOptionRef:ae(e,"renderOption"),labelFieldRef:ae(e,"labelField"),valueFieldRef:ae(e,"valueField")}),Ze(Ii,a),bt(()=>{const{value:w}=l;w&&w.sync()});const W=P(()=>{const{size:w}=e,{common:{cubicBezierEaseInOut:O},self:{height:D,borderRadius:J,color:ye,groupHeaderTextColor:de,actionDividerColor:ge,optionTextColorPressed:L,optionTextColor:ie,optionTextColorDisabled:ke,optionTextColorActive:Se,optionOpacityDisabled:Be,optionCheckColor:De,actionTextColor:je,optionColorPending:$e,optionColorActive:K,loadingColor:le,loadingSize:H,optionColorActivePending:fe,[me("optionFontSize",w)]:we,[me("optionHeight",w)]:xe,[me("optionPadding",w)]:Ce}}=r.value;return{"--n-height":D,"--n-action-divider-color":ge,"--n-action-text-color":je,"--n-bezier":O,"--n-border-radius":J,"--n-color":ye,"--n-option-font-size":we,"--n-group-header-text-color":de,"--n-option-check-color":De,"--n-option-color-pending":$e,"--n-option-color-active":K,"--n-option-color-active-pending":fe,"--n-option-height":xe,"--n-option-opacity-disabled":Be,"--n-option-text-color":ie,"--n-option-text-color-active":Se,"--n-option-text-color-disabled":ke,"--n-option-text-color-pressed":L,"--n-option-padding":Ce,"--n-option-padding-left":Wt(Ce,"left"),"--n-option-padding-right":Wt(Ce,"right"),"--n-loading-color":le,"--n-loading-size":H}}),{inlineThemeDisabled:te}=e,Z=te?it("internal-select-menu",P(()=>e.size[0]),W,e):void 0,A={selfRef:a,next:_,prev:k,getPendingTmNode:z};return rr(a,e.onResize),Object.assign({mergedTheme:r,mergedClsPrefix:t,rtlEnabled:o,virtualListRef:s,scrollbarRef:l,itemSize:v,padding:f,flattenedNodes:d,empty:m,virtualListContainer(){const{value:w}=s;return w==null?void 0:w.listElRef},virtualListContent(){const{value:w}=s;return w==null?void 0:w.itemsElRef},doScroll:S,handleFocusin:j,handleFocusout:U,handleKeyUp:T,handleKeyDown:M,handleMouseDown:X,handleVirtualListResize:R,handleVirtualListScroll:C,cssVars:te?void 0:W,themeClass:Z==null?void 0:Z.themeClass,onRender:Z==null?void 0:Z.onRender},A)},render(){const{$slots:e,virtualScroll:t,clsPrefix:n,mergedTheme:o,themeClass:r,onRender:a}=this;return a==null||a(),i("div",{ref:"selfRef",tabindex:this.focusable?0:-1,class:[`${n}-base-select-menu`,this.rtlEnabled&&`${n}-base-select-menu--rtl`,r,this.multiple&&`${n}-base-select-menu--multiple`],style:this.cssVars,onFocusin:this.handleFocusin,onFocusout:this.handleFocusout,onKeyup:this.handleKeyUp,onKeydown:this.handleKeyDown,onMousedown:this.handleMouseDown,onMouseenter:this.onMouseenter,onMouseleave:this.onMouseleave},Lt(e.header,s=>s&&i("div",{class:`${n}-base-select-menu__header`,"data-header":!0,key:"header"},s)),this.loading?i("div",{class:`${n}-base-select-menu__loading`},i(jn,{clsPrefix:n,strokeWidth:20})):this.empty?i("div",{class:`${n}-base-select-menu__empty`,"data-empty":!0},Dt(e.empty,()=>[i(dr,{theme:o.peers.Empty,themeOverrides:o.peerOverrides.Empty,size:this.size})])):i(Hn,{ref:"scrollbarRef",theme:o.peers.Scrollbar,themeOverrides:o.peerOverrides.Scrollbar,scrollable:this.scrollable,container:t?this.virtualListContainer:void 0,content:t?this.virtualListContent:void 0,onScroll:t?void 0:this.doScroll},{default:()=>t?i(Xn,{ref:"virtualListRef",class:`${n}-virtual-list`,items:this.flattenedNodes,itemSize:this.itemSize,showScrollbar:!1,paddingTop:this.padding.top,paddingBottom:this.padding.bottom,onResize:this.handleVirtualListResize,onScroll:this.handleVirtualListScroll,itemResizable:!0},{default:({item:s})=>s.isGroup?i(yo,{key:s.key,clsPrefix:n,tmNode:s}):s.ignored?null:i(xo,{clsPrefix:n,key:s.key,tmNode:s})}):i("div",{class:`${n}-base-select-menu-option-wrapper`,style:{paddingTop:this.padding.top,paddingBottom:this.padding.bottom}},this.flattenedNodes.map(s=>s.isGroup?i(yo,{key:s.key,clsPrefix:n,tmNode:s}):i(xo,{clsPrefix:n,key:s.key,tmNode:s})))}),Lt(e.action,s=>s&&[i("div",{class:`${n}-base-select-menu__action`,"data-action":!0,key:"action"},s),i(ta,{onFocus:this.onTabOut,key:"focus-detector"})]))}}),Ta=Y([F("base-selection",`
