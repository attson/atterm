// PR D: admin static UI under web/legacy/admin/. Assert the structural
...
test("admin/index.html declares <meta name=\"page\" content=\"admin\">", () => {
    const html = readFileSync("web/legacy/admin/index.html", "utf8");
...
test("admin.js calls /admin/api/config (GET + PUT)", () => {
    const js = readFileSync("web/legacy/admin/admin.js", "utf8");
...
test("admin-invitations.js calls POST /admin/api/invitations + GET list", () => {
    const js = readFileSync("web/legacy/admin/admin-invitations.js", "utf8");
...
test("admin-users.js wires promote (POST) + demote (DELETE) admin endpoints", () => {
    const js = readFileSync("web/legacy/admin/admin-users.js", "utf8");
