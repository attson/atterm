...
import { _resetHandlersForTest, pasteImageBus } from "@/main/lib/pasteImageBus";
...
describe("PasteImagePreviewHost (web)", () => {
  ...
  // to the actual method signatures instead. Vitest 2.x takes a single
  // function-type generic (not the [args, return] tuple form 1.x used).
